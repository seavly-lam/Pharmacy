    ...
    public function index(Request $request)
{
    ...
    if ($request->ajax()) {
        ...
        // Debug output - check Laravel logs/storage/logs/laravel.log for this line
        \Log::info('Sales AJAX called', ['count' => $sales->count()]);

        // For quick debug (uncomment only to test and stop execution)
        // dd($sales->toArray());
