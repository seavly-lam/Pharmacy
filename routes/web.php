...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::get('dashboard/popular-sales', [DashboardController::class, 'popularSalesData'])->name('dashboard.popularSales'); // NEW popular sales route
    Route::get('', [DashboardController::class, 'index']); // admin root
...
Route::middleware(['guest'])->prefix('admin')->group(function () {
    Route::get('', [DashboardController::class, 'index']); // admin root for guests
