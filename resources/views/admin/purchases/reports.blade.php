			...
			buttons: [
				{
					...
					text: 'Export Data',
					buttons: [
						{ extend: 'pdf', exportOptions: { columns: "thead th" }},
						{ extend: 'excel', exportOptions: { columns: "thead th" }},
						{ extend: 'csv', exportOptions: { columns: "thead th" }},
						{ extend: 'print', exportOptions: { columns: "thead th" }}
					]
				}
			]
		});
